...
// CMFC的WinInet示例1Dlg 消息处理程序

BOOL CMFC的WinInet示例1Dlg::OnInitDialog()
{
...
void CMFC的WinInet示例1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CMFC的WinInet示例1Dlg::OnQueryDragIcon()
{
